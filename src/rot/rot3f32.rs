use crate::{vec::{vec3f32::Vec3f32, vec4f32::Vec4f32}, mat::mat4f32::Mat4f32};
...
impl Rot3f32 {
    ...
    /// (First self then r)
    pub fn appended(&self, r: Rot3f32) -> Self {
        let mut result = *self;
        result.append(r);
        result
    }
    ...
    pub fn append(&mut self, r: Rot3f32) {
    ...
    pub fn rotation_mat(&self) -> Mat4f32 {
        ...
        Mat4f32::new_row_major(
            Vec4f32::new(new_x.x, new_y.x, new_z.x, 0.0),
            Vec4f32::new(new_x.y, new_y.y, new_z.y, 0.0),
            Vec4f32::new(new_x.z, new_y.z, new_z.z, 0.0),
...
mod tests {
    ...
    fn test_double_rotation_fix() {
        ...
        let rotor = Rot3f32::new_exact(a, b);
