...
impl Mat4f32 {
    pub fn new_row_major(row1: Vec4f32, row2: Vec4f32, row3: Vec4f32, row4: Vec4f32) -> Self {
        Self {
            cols: [
                Vec4f32::new(row1.x, row2.x, row3.x, row4.x),
                Vec4f32::new(row1.y, row2.y, row3.y, row4.y),
                Vec4f32::new(row1.z, row2.z, row3.z, row4.z),
                Vec4f32::new(row1.w, row2.w, row3.w, row4.w),
            ],
        }
    }

    pub fn new_column_major(col1: Vec4f32, col2: Vec4f32, col3: Vec4f32, col4: Vec4f32) -> Self {
        Self {
    ...
    pub fn identity() -> Self {
        Self {
            cols: [
                Vec4f32::new(1.0, 0.0, 0.0, 0.0),
                Vec4f32::new(0.0, 1.0, 0.0, 0.0),
                Vec4f32::new(0.0, 0.0, 1.0, 0.0),
                Vec4f32::new(0.0, 0.0, 0.0, 1.0),
            ],
        }
    }
...
impl Add<Mat4f32> for Mat4f32 {
    type Output = Mat4f32;
    fn add(mut self, rhs: Mat4f32) -> Self::Output {
...
impl AddAssign<Mat4f32> for Mat4f32 {
    fn add_assign(&mut self, rhs: Mat4f32) {
        self.cols[0] += rhs.cols[0];
        self.cols[1] += rhs.cols[1];
        self.cols[2] += rhs.cols[2];
        self.cols[3] += rhs.cols[3];
...
impl Sub<Mat4f32> for Mat4f32 {
    type Output = Mat4f32;
    fn sub(mut self, rhs: Mat4f32) -> Self::Output {
        self.cols[0] -= rhs.cols[0];
        self.cols[1] -= rhs.cols[1];
        self.cols[2] -= rhs.cols[2];
        self.cols[3] -= rhs.cols[3];
...
impl SubAssign<Mat4f32> for Mat4f32 {
    fn sub_assign(&mut self, rhs: Mat4f32) {
        self.cols[0] -= rhs.cols[0];
        self.cols[1] -= rhs.cols[1];
        self.cols[2] -= rhs.cols[2];
        self.cols[3] -= rhs.cols[3];
...
impl Mul<Mat4f32> for Mat4f32 {
    type Output = Mat4f32;
    fn mul(self, rhs: Mat4f32) -> Self::Output {
...
impl MulAssign<Mat4f32> for Mat4f32 {
    fn mul_assign(&mut self, rhs: Mat4f32) {
        let result = *self * rhs;
        self.cols = result.cols;
    }
}

impl Mul<f32> for Mat4f32 {
    type Output = Mat4f32;
...
impl Mul<Mat4f32> for f32 {
    type Output = Mat4f32;
    fn mul(self, mut mat: Mat4f32) -> Self::Output {
        mat.cols[0] *= self;
        mat.cols[1] *= self;
        mat.cols[2] *= self;
        mat.cols[3] *= self;
...
impl MulAssign<f32> for Mat4f32 {
...
impl DivAssign<f32> for Mat4f32 {
...
mod tests {
    ...
    #[test]
    fn matrix_creation() {
        let m = Mat4f32::new_column_major(
            Vec4f32::new(1.0, 2.0, 3.0, 4.0),
            Vec4f32::new(5.0, 6.0, 7.0, 8.0),
            Vec4f32::new(9.0, 10.0, 11.0, 12.0),
            Vec4f32::new(13.0, 14.0, 15.0, 16.0),
        );
        ...
        let m = Mat4f32::new_row_major(
            Vec4f32::new(1.0, 5.0, 9.0, 13.0),
            Vec4f32::new(2.0, 6.0, 10.0, 14.0),
            Vec4f32::new(3.0, 7.0, 11.0, 15.0),
            Vec4f32::new(4.0, 8.0, 12.0, 16.0),
        );
        assert_eq!(m.cols[0].x, 1.0);
        assert_eq!(m.cols[0].y, 2.0);
        assert_eq!(m.cols[0].z, 3.0);
    ...
    #[test]
    fn transpose() {
        let mut m = Mat4f32::new_column_major(
            Vec4f32::new(1.0, 2.0, 3.0, 4.0),
            Vec4f32::new(5.0, 6.0, 7.0, 8.0),
            Vec4f32::new(9.0, 10.0, 11.0, 12.0),
            Vec4f32::new(13.0, 14.0, 15.0, 16.0),
    ...
    #[test]
    fn addition() {
        let mut one = Mat4f32::new_column_major(
            Vec4f32::new(1.0, 1.0, 1.0, 1.0),
            Vec4f32::new(1.0, 1.0, 1.0, 1.0),
            Vec4f32::new(1.0, 1.0, 1.0, 1.0),
            Vec4f32::new(1.0, 1.0, 1.0, 1.0),
        );
    ...
    #[test]
    fn subtraction() {
        let one = Mat4f32::new_column_major(
            Vec4f32::new(1.0, 1.0, 1.0, 1.0),
            Vec4f32::new(1.0, 1.0, 1.0, 1.0),
            Vec4f32::new(1.0, 1.0, 1.0, 1.0),
            Vec4f32::new(1.0, 1.0, 1.0, 1.0),
    ...
    #[test]
    fn multiplication() {
        let mut a = Mat4f32::new_column_major(
            Vec4f32::new(1.0, 2.0, 3.0, 4.0),
            Vec4f32::new(5.0, 6.0, 7.0, 8.0),
            Vec4f32::new(9.0, 10.0, 11.0, 12.0),
            Vec4f32::new(13.0, 14.0, 15.0, 16.0),
        );
        let b = Mat4f32::new_column_major(
            Vec4f32::new(17.0, 18.0, 19.0, 20.0),
            Vec4f32::new(21.0, 22.0, 23.0, 24.0),
            Vec4f32::new(25.0, 26.0, 27.0, 28.0),
            Vec4f32::new(29.0, 30.0, 31.0, 32.0),
        );
        let c = a * b;
    ...
    fn scalar_multiplication() {
        ...
        let mut four: Mat4f32 = 2.0 * one * 2.0;
    ...
    #[test]
    fn multiply_vector() {
        let a = Mat4f32::new_column_major(
            Vec4f32::new(1.0, 5.0, 9.0, 13.0),
            Vec4f32::new(2.0, 6.0, 10.0, 14.0),
            Vec4f32::new(3.0, 7.0, 11.0, 15.0),
            Vec4f32::new(4.0, 8.0, 12.0, 16.0),
        );
        let vec = Vec4f32::new(2.0, 3.0, 4.0, 5.0);
        let c = a * vec;
        assert_eq!(c.x, 40.0);
        assert_eq!(c.y, 96.0);
        assert_eq!(c.z, 152.0);
